...
Route::post('/branch/{store}/remove-user', [BranchController::class, 'removeUser'])->middleware('auth');
Route::get('/branch/deletebranch', [BranchController::class, 'DeleteBranch'])->name('DeleteBranch')->middleware('auth');
